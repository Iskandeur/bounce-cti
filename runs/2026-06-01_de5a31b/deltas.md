# Deltas — 2026-06-01 · commit de5a31b
...
- BD=100  (cti_calls=28, budget_extension_count=0)
- RQ=70  (actor_in_report=True, marker_in_report=True, node_pct=63.6%, has_summary=True)
- Hypothesis: present=True category=apt_targeted history_len=2 final_category=apt_targeted valid=True
...
- PC=100.0  (4/4 pivot rules fired)
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=100  (cti_calls=29, budget_extension_count=0)
...
- Phase 3 tools used: ['certspotter_issuances', 'certspotter_serial', 'dom_fingerprints', 'netlas_jarm', 'whoxy_reverse', 'zoomeye_jarm']
- Graph: 34 nodes / 44 edges
...
- PC=100.0  (4/4 pivot rules fired)
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=50  (cti_calls=63, budget_extension_count=0)
...
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=100  (cti_calls=44, budget_extension_count=0)
...
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=100  (cti_calls=41, budget_extension_count=0)
- RQ=70  (actor_in_report=True, marker_in_report=True, node_pct=66.7%, has_summary=True)
- Hypothesis: present=True category=commodity_malware history_len=2 final_category=commodity_malware valid=True
- Phase 3 tools used: ['abuseipdb_check', 'certspotter_issuances', 'certspotter_serial', 'criminalip_ip', 'netlas_jarm', 'zoomeye_jarm']
- Graph: 32 nodes / 30 edges

## Cross-case patterns

- Median CTI calls per case: 41.
