# Deltas — 2026-06-17 · commit 71e5fb1
...
- Hypothesis: present=True category=commodity_malware history_len=2 final_category=traffer_or_tds / initial_access_loader (Bumblebee -> AdaptixC2 -> Akira) valid=True
- Phase 3 tools used: ['abuseipdb_check', 'criminalip_ip', 'netlas_jarm', 'netlas_search', 'zoomeye_jarm', 'zoomeye_search']
- Graph: 36 nodes / 39 edges
...
- PC=100.0  (4/4 pivot rules fired)
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=100  (cti_calls=58, budget_extension_count=0)
...
- Phase 3 tools used: ['abuseipdb_check', 'certspotter_serial', 'criminalip_ip', 'dom_fingerprints']
- Graph: 33 nodes / 45 edges
...
- DC=100  (over_inclusion=0, over_defuse=0)
- BD=100  (cti_calls=17, budget_extension_count=0)
